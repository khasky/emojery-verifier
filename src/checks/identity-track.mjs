...
export async function checkIdentityTrack(entries, { repo, proofsBase, keysPerAccount, allowUnsignedVotes, blindPubkey, proofsDisabled, enrollVkHash, saltCommitment, issuers, audiences, bbVersion, mirroredThrough }) {
